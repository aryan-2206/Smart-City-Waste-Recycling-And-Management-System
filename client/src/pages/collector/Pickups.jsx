                                                ...
                                                <div className="flex items-center justify-end gap-1.5 mt-1 pt-2 border-t border-slate-100 dark:border-white/5">
                                                    ...
                                                    {report.status === 'In Progress' && (
                                                        <div className="flex flex-wrap items-center justify-end gap-1.5">
                                                            {(report.evidenceUploaded || (report.initialPhotoCount !== undefined && report.photos?.length > report.initialPhotoCount) || (report.photos && report.photos.length > 2)) ? (
                                                                <>
                                                                    <button
                                                                        onClick={(e) => {
                                                                            e.stopPropagation();
                                ...
                                <div className="pt-2">
                                    ...
                                    {viewingReport.status === 'In Progress' && (
                                        <div className="flex flex-col gap-2">
                                            {(viewingReport.evidenceUploaded || (viewingReport.photos && viewingReport.photos.length > (viewingReport.initialPhotoCount || 1))) ? (
                                                <>
                                                    <button
                                                        onClick={() => {
